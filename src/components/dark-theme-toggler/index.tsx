...
export default function DarkThemeToggler() {
  ...
  return (
    <Container onClick={themeContext.toggleTheme} className='group'>
      ...
      >
        <g fill="none" stroke="#D14009" stroke-width="1" stroke-linecap="round">
          <circle cx="6" cy="6" r="2" />
          <g stroke-dasharray="1.5 1.5">
            <SwitchPolyline points="6 10,6 11.5" transform="rotate(0,6,6)" />
            <SwitchPolyline points="6 10,6 11.5" transform="rotate(45,6,6)" />
            <SwitchPolyline points="6 10,6 11.5" transform="rotate(90,6,6)" />
            <SwitchPolyline points="6 10,6 11.5" transform="rotate(135,6,6)" />
            <SwitchPolyline points="6 10,6 11.5" transform="rotate(180,6,6)" />
            <SwitchPolyline points="6 10,6 11.5" transform="rotate(225,6,6)" />
            <SwitchPolyline points="6 10,6 11.5" transform="rotate(270,6,6)" />
            <SwitchPolyline points="6 10,6 11.5" transform="rotate(315,6,6)" />
          </g>
        </g>
      </SwitchIcon>
      <SwitchIcon
      ...
      >
        <g fill="none" stroke="#F6F1D5" stroke-width="1" stroke-linejoin="round" transform="rotate(-45,6,6)">

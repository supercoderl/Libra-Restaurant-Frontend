...
export const Plan = tw.div`w-full bg-veryPaleBlue py-[18px] px-[15px] rounded-md mt-[16px] mb-[20px] grid grid-cols-4 items-center cursor-pointer transition duration-500 hover:scale-105`;

export const PlanImage = tw.div`col-span-1`;

export const PlanContent = tw.div`col-span-2`;

export const PlanContentName = tw.h4`text-sm font-bold text-darkBlue`;
...
export const Image = tw.img`w-[70%] rounded-full`;
...
export const SvgCheckout = tw.svg`h-[20px] transition transform duration-500 group-hover:rotate-360`;

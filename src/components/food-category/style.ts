...
export const SecondaryContainer = tw.div`w-fit px-20 mb-10 bg-[rgba(255,_255,_255,_0.75)] rounded-md border-2 border-[rgba(255, 255, 255, 0.3)] shadow-secondaryCategory`;

export const CategoryFood = tw.ul`list-none	flex flex-nowrap justify-center p-0`;

...
const ItemDetail: React.FC<ItemDetailProps> = ({ isOpen, handleCancel, item }) => {
    return (
        <Modal title="Thông tin món" open={isOpen} onOk={handleCancel} onCancel={handleCancel} width={1000} footer={null}>
            <DetailContainer>
                <DetailWrapper>
                    ...
                    <DetailContent>
                        ...
                        <DetailPreviewContainer>
                            <DetailPreviewStartContainer>
                                <svg fill="orange" stroke="orange" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" width={16} className="text-indigo-500" viewBox="0 0 24 24">
                                ...
                                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" width={16} className="text-indigo-500" viewBox="0 0 24 24">
                                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path>
                                </svg>
                                <DetailPreviewStartText>20 đánh giá</DetailPreviewStartText>
                            </DetailPreviewStartContainer>
                        </DetailPreviewContainer>
